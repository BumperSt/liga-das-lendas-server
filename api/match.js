...
module.exports = {
    ...
    getMatchList: (puuid,matchType, startIndex) => historyApi.get(`/lol/match/v5/matches/by-puuid/${puuid}/ids?${matchType != 'default' && `type=${matchType}&`}start=${startIndex}&count=10`)
}
